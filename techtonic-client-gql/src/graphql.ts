...
export type LoginMutation = {
	...
	auth: {
		...
		login: {
			__typename?: 'LoginPayload';
			accessToken: { __typename?: 'Token'; tokenValue: string; expiresAt: any };
			refreshToken: { __typename?: 'Token'; tokenValue: string; expiresAt: any };
			user?: {
				__typename?: 'User';
				id: string;
				name: string;
				status: UserStatus;
				roles: Array<{ __typename?: 'RoleRef'; id: string; name: string }>;
			} | null;
		};
	};
};
...
export type LogoutMutation = {
	__typename?: 'Mutation';
	auth: { __typename?: 'AuthMutation'; logout: { __typename?: 'LogoutPayload'; message: string } };
};
										...
										selections: [
											{
												...
												selectionSet: {
													kind: 'SelectionSet',
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: 'tokenValue' } },
							...
							selections: [
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{ kind: 'Field', name: { kind: 'Name', value: 'lastLoginTime' } },
											{
												kind: 'Field',
												name: { kind: 'Name', value: 'roles' },
												selectionSet: {
